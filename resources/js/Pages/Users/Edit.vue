    ...
    <BreezeAuthenticatedLayout>
        ...
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Edit details for {{ user.firstname }}
            </h2>
        </template>
        ...
        >
            ...
            <div class="flex justify-between ">
                <Button type="button" class="text-base" appearance="danger" @click="deleteModalIsOpen = true">
                    Delete
                </Button>
                <div class="space-x-2">
        ...
        <DeleteModal :open="deleteModalIsOpen" :user-id="user.id" @close="deleteModalIsOpen = false" />
    </BreezeAuthenticatedLayout>
</template>
        ...
        return {
            ...
            form: this.$inertia.form({
                ...
                can: {
                    ...
                    manageUsers: this.user.can.manageUsers,
                    manageDigitalBoard: this.user.can.manageDigitalBoard,
                },
                canBe: {
                    chairmanAtPublicMeetings: this.user.canBe.chairmanAtPublicMeetings,
                    watchtowerReader: this.user.canBe.watchtowerReader,
                    serviceMeetingsLeader: this.user.canBe.serviceMeetingsLeader,
                }
            })
        }
    },
